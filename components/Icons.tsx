...
// Simple wrapper to avoid large dependency import in this constrained environment
// We are manually implementing a few critical icons to ensure it runs without 'lucide-react' installed in the runner if unavailable.
// If using a real setup, import { X, Upload, ... } from 'lucide-react'
...
export const IconType = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
